window.AES_SERVICES=[
  {
    ...
    "en": {
      ...
      "short": "Independent audit, assurance, review, and compliance support that strengthens business confidence.",
      "h1": "Audit and Assurance Services in Egypt",
      "description": "AES Egypt provides audit and assurance services in Egypt for companies that need reliable financial statement review, compliance clarity, and stronger stakeholder confidence. Our work is designed to support management, investors, lenders, and regulatory obligations with disciplined professional judgment.",
      "who": [
    ...
    "ar": {
      ...
      "short": "خدمات تدقيق ومراجعة مستقلة تدعم الالتزام وتعزز ثقة الإدارة والمستثمرين.",
      "h1": "خدمات تدقيق ومراجعة الحسابات في مصر",
      "description": "تقدم AES Egypt خدمات تدقيق ومراجعة الحسابات في مصر للشركات التي تحتاج إلى فحص مهني للقوائم المالية، وضمان أفضل للالتزام، ورؤية أوضح أمام الإدارة والمستثمرين والجهات ذات العلاقة.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Bookkeeping, accounting systems, reporting, and monthly financial record support.",
      "h1": "Professional Accounting Services in Egypt",
      "description": "AES Egypt helps businesses maintain organized records, reliable bookkeeping, and management-ready financial reports. Our accounting services in Egypt support day-to-day control and long-term growth.",
      "who": [
    ...
    "ar": {
      ...
      "short": "إمساك دفاتر وتنظيم سجلات ونظم محاسبية وتقارير شهرية تدعم الإدارة.",
      "h1": "خدمات محاسبية مهنية في مصر",
      "description": "تساعد AES Egypt الشركات على بناء سجلات مالية منظمة وتقارير موثوقة قابلة للاستخدام الإداري والضريبي. صممت خدماتنا المحاسبية في مصر لدعم الانضباط المالي والنمو المستدام.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Tax compliance, tax planning, legal support, and corporate obligation guidance.",
      "h1": "Tax and Legal Services in Egypt",
      "description": "AES Egypt supports companies with tax services in Egypt, legal coordination, corporate compliance, and practical guidance on Egyptian tax regulations and business obligations.",
      "who": [
    ...
    "ar": {
      ...
      "short": "دعم ضريبي وقانوني للشركات يشمل الالتزام والتخطيط ومتابعة الالتزامات.",
      "h1": "خدمات ضريبية وقانونية في مصر",
      "description": "تدعم AES Egypt الشركات من خلال خدمات ضريبية في مصر تشمل الالتزام الضريبي والتخطيط والتوجيه المهني بشأن اللوائح الضريبية والالتزامات القانونية والتجارية.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Financial planning, business analysis, reporting, and investment decision support.",
      "h1": "Financial Advisory and Consulting in Egypt",
      "description": "AES Egypt provides financial consulting in Egypt for companies that need stronger planning, performance analysis, reporting discipline, investment support, and decision-ready financial insight.",
      "who": [
    ...
    "ar": {
      ...
      "short": "تخطيط وتحليل مالي وتقارير إدارية ودعم قرارات الاستثمار والنمو.",
      "h1": "استشارات مالية في مصر",
      "description": "تقدم AES Egypt استشارات مالية في مصر للشركات التي تحتاج إلى تخطيط أقوى وتحليل أداء وتقارير منظمة ودعم مهني لاتخاذ قرارات الاستثمار والنمو.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Registration support, required documents, and post-formation guidance for Egypt.",
      "h1": "Company Formation in Egypt",
      "description": "AES Egypt supports entrepreneurs, investors, and foreign companies with company formation Egypt guidance, registration coordination, required documents, and post-formation accounting and tax readiness.",
      "who": [
    ...
    "ar": {
      "title": "تأسيس الشركات",
      "short": "دعم تأسيس الشركات في مصر من المستندات والتسجيل إلى المتابعة بعد التأسيس.",
      "h1": "تأسيس شركات في مصر",
      "description": "تدعم AES Egypt رواد الأعمال والمستثمرين والشركات الأجنبية في تأسيس شركات في مصر من خلال توضيح المتطلبات وتنسيق التسجيل والمستندات والإعداد للالتزامات المحاسبية والضريبية بعد التأسيس.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Market entry, business planning, growth strategy, and corporate structuring support.",
      "h1": "Investment and Business Advisory in Egypt",
      "description": "AES Egypt provides business advisory Egypt support for investors and companies planning market entry, corporate structuring, growth strategy, business planning, and operational improvement.",
      "who": [
    ...
    "ar": {
      ...
      "short": "دعم دخول السوق والتخطيط والنمو وهيكلة الشركات للمستثمرين والأعمال.",
      "h1": "استشارات استثمار وأعمال في مصر",
      "description": "تقدم AES Egypt استشارات أعمال في مصر للمستثمرين والشركات في مجالات دخول السوق وهيكلة الشركات واستراتيجيات النمو والتخطيط وتحسين الأداء التشغيلي.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Professional financial, tax, business, and customized corporate training programs.",
      "h1": "Professional Training and Consulting Services",
      "description": "AES Egypt delivers professional training and consulting for companies that need stronger internal capability in finance, accounting, tax awareness, reporting, and business management.",
      "who": [
    ...
    "ar": {
      ...
      "short": "برامج تدريب واستشارات مالية وضريبية وإدارية مخصصة للشركات.",
      "h1": "خدمات التدريب والاستشارات المهنية",
      "description": "تقدم AES Egypt برامج تدريب واستشارات مهنية للشركات التي تسعى إلى بناء قدرات داخلية أقوى في المالية والمحاسبة والوعي الضريبي والتقارير وإدارة الأعمال.",
      "who": [
  ...
  },
  {
    ...
    "en": {
      ...
      "short": "Professional business, legal, financial, and corporate translation services.",
      "h1": "Business, Legal, and Financial Translation Services",
      "description": "AES Egypt provides professional translation services for corporate, legal, financial, and business documents where accuracy, confidentiality, and context matter.",
      "who": [
    ...
    "ar": {
      "title": "خدمات الترجمة",
      "short": "ترجمة مهنية للمستندات التجارية والقانونية والمالية ومستندات الشركات.",
      "h1": "خدمات ترجمة تجارية وقانونية ومالية",
      "description": "تقدم AES Egypt خدمات ترجمة مهنية للمستندات التجارية والقانونية والمالية ومستندات الشركات حيث تكون الدقة والسرية وفهم السياق عناصر أساسية.",
      "who": [
